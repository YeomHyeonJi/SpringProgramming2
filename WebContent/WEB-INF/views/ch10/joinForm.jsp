...
<h5>회원가입</h5>
	...
	<div class="form-group">
		...
		<div class="input-group">
		  <input id="mid" name="mid" type="text" class="form-control" placeholder="아이디 입력하세요">
		...
		<div class="form-group">
			...
			<input id="mpassword" name="mpassword" type="password" class="form-control"  placeholder="비밀번호를입력하세요">
